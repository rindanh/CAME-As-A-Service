export const SpecificationByExample = {
      ...
      workProducts: [
        {
          ...
          levelOfDetails: ["Identified", "Defined", "Communicated", "Achieved"]
        },
        {
      ...
      states: [
        {
          ...
          name: "Defined",
          description:
            "Documentation is planned and defined of what it will be comprised of.",
          checklists: [
        ...
        },
        {
          ...
          name: "Updated",
          description:
            "Documentation is regularly updated and synchronized with the product. It is updated by many members of various divisions.",
          checklists: [
