export const AgileRetrospective = {
  nameId: "AgileRetrospective",
  ...
  activitySpaces: [
    {
      ...
      activities: [
        {
          nameId: "HoldARetrospective",
          name: "Hold a Retrospective",
          description:
          ...
          entryCriterions: {
            alphas: ["Improvement.Identified"],
            workProducts: []
          },
          completionCriterions: {
            alphas: ["WayOfWorking.WorkingWell", "Improvement.ActionAgreed"],
            workProducts: []
          },
      ...
      states: [
        {
          ...
          name: "Identified",
          description:
            "A possible adaptation to improve a team’s way of working has been identified.",
          checklists: [
            "A possible adaptation to improve a team’s way of working has been identified"
          ]
        },
        {
          ...
          name: "Prioritized",
          description:
            "A possible adaptation to improve a team’s way of working has been prioritized so support decisions on what to focus on improving and when.A possible adaptation to a team’s way of working has been prioritized to support decisions on what to focus on improving and when. Action Agreed",
          checklists: [
            "A possible adaptation to a team’s way of working has been prioritized to support decisions on what to focus on improving and when. Action Agreed"
          ]
        },
        {
          nameId: "ActionAgreed",
          name: "Action Agreed",
          description:
            "It has been agreed what action to take to enact or otherwise respond to an improvement.",
          checklists: [
            "It has been agreed what action to take to enact or otherwise respond to an improvement",
            "It is clear when the action will be taken",
            "It is clear who is responsible for the action",
            "It is agreed how the results of the actions will be measured to prove whether or not an improvement has been achieved"
          ]
        },
        {
          nameId: "Trialed",
          name: "Trialed",
          description:
            "The improvement has been enacted in such a way that the team is able to assess its success and decide whether to continue with the enactment, reverse out of it, or adapt it in some way.",
          checklists: [
            "The improvement has been enacted in such a way that the team is able to assess its success and decide whether to continue with the enactment, reverse out of it, or adapt it"
          ]
        },
        {
          nameId: "ResultsEvaluated",
          name: "Results Evaluated",
          description:
            "The team has assessed the success or otherwise of the improvement.",
          checklists: [
            "The team has assessed the success or otherwise of the improvement",
        ...
        },
        {
          ...
          name: "In Use",
          description:
            "The improvement is in use and now a fully embedded part of the team’s way of working.",
          checklists: [
            "The improvement is now a fully embedded part of the team's agreed way of working"
          ]
        }
      ],
      subalphaIds: []
  ...
  patterns: [
    {
      ...
      nameId: "Feedback",
      description:
        "Feedback patterns establish mechanisms for assessing performance and adjusting the approach based on these assessments. Apply feedback patterns to: Assess performance and results, Seek input from stakeholders, Analyze reasons for underperformance, Ensure assessments are open and honest, Enable lessons to be learnt, Enable approaches to be adjusted.",
      alphas: [],
      activities: [],
      competencies: [],
      subpatternIds: ["MadSadGlad"]
    },
    {
      name: "Mad, Sad, Glad",
      nameId: "MadSadGlad",
      description:
        "A popular approach to team brainstorming to identify potential improvements. Team members write on sticky notes what has made them: Mad – frustrations, Sad – disappointments, Glad – things that went well. Part of its power is that it taps into people’s emotions, and results in an unfettered flow of ideas that the team can then analyze, prioritize and action.",
      alphas: [],
      activities: ["HoldARetrospective"],
      competencies: [],
      subpatternIds: []
    }
  ]
