export const BehaviorDrivenDevelopment = {
  ...
  activitySpaces: [
    {
      ...
      activities: [
        ...
        },
        {
          ...
          description:
            "Define behavioral specification of what the feature is like using DSL",
          entryCriterions: {
            alphas: ["Requirements.Conceived"],
            workProducts: ["BehaviorSpecification.Identified"]
          },
      ...
      workProducts: [
        {
          ...
          levelOfDetails: ["Identified", "Defined", "Communicated"]
        }
      ],
      states: [
        {
