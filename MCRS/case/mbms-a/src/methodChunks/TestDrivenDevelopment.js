export const TestDrivenDevelopment = {
  ...
  alphas: [
    ...
    },
    {
      ...
      name: "Unit Program",
      description:
        "Small subset of a whole software system. Usually it is independent and acts as a separated module or function.",
      workProducts: [
        {
          nameId: "UnitTest",
          name: "Unit Test",
          ...
          levelOfDetails: ["Initiated", "TestCasesDefined", "Developed"]
        }
      ],
      states: [
        {
          ...
          description:
            "Requirement or goal of the function/module has been defined.",
          checklists: ["Requirement defined", "Goals defined"]
        },
        {
          nameId: "ReadyToDevelop",
          name: "ReadyToDevelop",
          description: "Function or module is ready to develop.",
          checklists: ["Unit test has been developed"]
        },
        {
          nameId: "Developed",
          name: "Developed",
          description:
            "Program has been functional and passed all the unit tests.",
          checklists: [
        ...
        },
        {
          ...
          name: "Finished",
          description:
            "Program has been refactored and clean, with existing best practices.",
          checklists: [
  ...
  patterns: [
    {
      ...
      description:
        "For TDD, a unit is most commonly defined as a class, or a group of related functions often called a module. Keeping units relatively small is claimed to provide critical benefits, including: Reduced debugging effort – When test failures are detected, having smaller units aids in tracking down errors, Self-documenting tests – Small test cases are easier to read and to understand.",
      alphas: ["UnitProgram"],
